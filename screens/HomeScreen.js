...
const HomeScreen = () => {
  ...
  return (
    <SafeAreaView className="bg-white flex-1 relative">
        ...
        <View className="flex-row px-6 mt-8 items-center gap-2">
        ...
        <View className="px-6 mt-8 gap-3">
            ...
            <Text className="text-[#3C6072] text-base">
                Loren ipsum dolor sit amet consectetur adipisicing elit. Deleniti odio quis nostrum
            </Text>
        </View>
            ...
            <View className="absolute bottom-20 w-24 h-24 border-l-2 border-r-2 border-t-4 border-[#00BCC9] rounded-full items-center justify-center">
                <TouchableOpacity>
                    <View className="w-20 h-20 items-center justify-center rounded-full bg-[#00BCC9]">
                        <Text className="text-gray-50 text-2xl font-semibold">Go</Text>
                    </View>
                </TouchableOpacity>
            </View>
        </View>
